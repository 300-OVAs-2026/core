...
export const PairLogicItems: React.FC<Props> & SubComponents = ({ children, onResult }) => {
...
PairLogicItems.Images = PairLogicImage;
PairLogicItems.Items = PairLogicText;
PairLogicItems.Button = PairLogicButton;
