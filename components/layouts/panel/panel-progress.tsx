...
export const PanelProgress = () => {
  ...
  return (
    <div className={`${css['progress']} u-mt-.5 u-pb-3`}>
      ...
      <ul
        ...
        <li role="presentation">
          <button
            ...
            className={`js-panel-next-button ${css['progress__button']} ${css['progress__button--next']}`}
...
const PanelProgressItem = forwardRef<HTMLButtonElement, PanelProgresItemProps>(function PanelProgressItem(
  ...
  const currentTitle = useMemo(() => {
    ...
    return titles[section - 1].replace(REMOVE_HTML_TAGS_REGEX, '');
