...
import { GamecircularQuizButton } from './game-circular-quiz-button';
import { GameCircularQuizProvider } from './game-circular-quiz-context';
import { GameCircularElement } from './game-circular-quiz-element';
import { GameCircularQuizQuestion } from './game-circular-quiz-question';
import { GameCircularWrapper } from './game-circular-wrapper';
...
type SubComponents = {
  GameCircularQuizElement: typeof GameCircularElement;
  GameCircularQuizButton: typeof GamecircularQuizButton;
  GameCicularQuizQuestion: typeof GameCircularQuizQuestion;
  GameCircularWrapper: typeof GameCircularWrapper;
};

const GameCircularQuiz: React.FC<Props> & SubComponents = ({ children, onResult, minSelected = 1, totalQuestion }) => {
...
GameCircularQuiz.GameCircularQuizElement = GameCircularElement;
GameCircularQuiz.GameCicularQuizQuestion = GameCircularQuizQuestion;
GameCircularQuiz.GameCircularQuizButton = GamecircularQuizButton;
GameCircularQuiz.GameCircularWrapper = GameCircularWrapper;

export { GameCircularQuiz };
