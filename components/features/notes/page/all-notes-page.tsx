...
const LazyPDFDownloadLink = lazy(() => import('@react-pdf/renderer').then((m) => ({ default: m.PDFDownloadLink })));
const LazyNotePDFDocument = lazy(() => import('../components/NotePDFDocument').then((m) => ({ default: m.NotePDFDocument })));
      ...
      <Row justifyContent="center" alignItems="center">
        <Col xs="11" mm="10" md="9" lg="8" hd="8" addClass="u-flow">
          ...
          <div className={css['notes-header']}>
            ...
            <p className={css['notes-subtitle']}>{totalNotes === 0 ? t.noNotes : t.noteCount(totalNotes)}</p>
          </div>
          ...
          {totalNotes === 0 && (
            <div className={css['empty-state']}>
              ...
              <p className={css['empty-hint']}>{t.emptyHint}</p>
            </div>
          )}
        </Col>
      </Row>
